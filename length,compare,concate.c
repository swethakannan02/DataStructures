...
*******************************************************************************/
//question:you are working on a program that manipulates strings using custom functions.your goal is to perform various tasks:
//tasks:
//length calculation:implement a function to find the length of a given string
//string concatenate:implement a function to concatenate two strings.
//string comparison:implement a function to compare two strings and determine their relationship.
#include <stdio.h>
#include<string.h>
//length
